...
<body>
    <aside class="sidebar p-3">
        ...
        <nav class="nav flex-column mt-4 gap-1">
            ...
            <a class="nav-link active" href="register.jsp"><i class="bi bi-person-plus me-2"></i>Add Employee</a>
            <a class="nav-link" href="manager.jsp#leave-requests"><i class="bi bi-clock-history me-2"></i>Leave Requests</a>
        </nav>
                ...
                <form action="RegisterServlet" method="post" class="row g-3">
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="nameInput" name="username" placeholder="Name" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="departmentInput" name="department" placeholder="Department" required>
