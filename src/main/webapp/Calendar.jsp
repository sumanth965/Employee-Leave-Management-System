<%@ page import="java.util.List" %>
    <%@ page import="model.Leave" %>
        <% String flashSuccess=(String) request.getAttribute("flashSuccess"); String flashError=(String)
            request.getAttribute("flashError"); List<Leave> calendarLeaves = (List<Leave>)
                request.getAttribute("calendarLeaves");
                %>
                <!DOCTYPE html>
                <html>
                            ...
                            <% } %>
                                ...
                                <% if (flashError !=null && !flashError.trim().isEmpty()) { %>
                                    ...
                                    <% } %>
                                        ...
                                        <!-- Leave Cards -->
                                        <div class="row g-3">
                                            <% if (calendarLeaves !=null) { for (Leave leave : calendarLeaves) { String
                                                status=leave.getStatus()==null ? "Pending" : leave.getStatus(); String
                                                statusClass="status-pending" ; if ("Approved".equalsIgnoreCase(status))
                                                { statusClass="status-approved" ; } else if
                                                ("Rejected".equalsIgnoreCase(status)) { statusClass="status-rejected" ;
                                                } %>
