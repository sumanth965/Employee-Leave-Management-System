                        ...
                        <body>
                            <aside class="sidebar p-3">
                                ...
                                <nav class="nav flex-column mt-4 gap-1">
                                    <a class="nav-link active" href="manager.jsp"><i
                                            class="bi bi-house-door me-2"></i>Dashboard</a>
                                    <a class="nav-link" href="register.jsp"><i class="bi bi-person-plus me-2"></i>Add
                                        Employee</a>
                                    <a class="nav-link" href="#leave-requests"><i
                                            class="bi bi-clock-history me-2"></i>Leave Requests</a>
                                </nav>
                            ...
                            <div class="main-wrap">
                                <header class="topbar d-flex justify-content-between align-items-center">
                                    <div>
                                        <h2 class="mb-0 topbar-heading">
                                            <% int
                                                ...
                                                <%= managerGreeting %>, <%= currentUser.getUsername() %>
                                        </h2>
                                        <small class="text-secondary">Review and manage employee leave requests
                                            efficiently.</small>
                                    </div>
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="dropdown">
                                            <button
                                                class="btn profile-dropdown dropdown-toggle d-flex align-items-center gap-2"
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="glass-card kpi-card p-3 p-md-4 h-100">
                                                <div>
                                                    ...
                                                    <h3 class="kpi-value pending mb-0">
                                                        <%= pendingCount %>
                                                    </h3>
                                                </div>
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="glass-card kpi-card p-3 p-md-4 h-100">
                                                <div>
                                                    ...
                                                    <h3 class="kpi-value approved mb-0">
                                                        <%= approvedCount %>
                                                    </h3>
                                                </div>
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="glass-card kpi-card p-3 p-md-4 h-100">
                                                <div>
                                                    ...
                                                    <h3 class="kpi-value rejected mb-0">
                                                        <%= rejectedCount %>
                                                    </h3>
                                                </div>
                                        ...
                                        <form method="GET" class="row g-3 align-items-end">
                                            ...
                                            <div class="col-md-3 d-grid">
                                                <button type="submit" class="btn btn-brand"><i
                                                        class="bi bi-search me-1"></i>Apply Filter</button>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <section id="leave-requests" class="glass-card p-3 p-md-4">
                                        ...
                                        <% if (leaveList !=null && !leaveList.isEmpty()) { %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <% if ("Pending".equalsIgnoreCase(status)) { %>
                                                                        ...
                                                                        <% } else { %>
                                                                            <span
                                                                                class="text-muted small">Completed</span>
                                                                            <% } %>
                                                                </td>
                                                            </tr>
                                                            <% } %>
                                            ...
                                            <div
                                                ...
                                                <small class="text-muted">Page <strong>
                                                        <%= pageNumber %>
                                                    </strong> of <strong>
                                                ...
                                                <div class="d-flex gap-2">
                                                    <% if (pageNumber> 1) { %>
                                                        <a class="btn btn-outline-secondary btn-sm"
                                                            href="?page=<%= pageNumber - 1 %>&search=<%= search %>&status=<%= statusFilter %>">Previous</a>
                                                        <% } %>
                                                            <% if (pageNumber < totalPages) { %>
                                                                <a class="btn btn-brand btn-sm"
                                                                    href="?page=<%= pageNumber + 1 %>&search=<%= search %>&status=<%= statusFilter %>">Next</a>
                                                                <% } %>
                                                </div>
                                            </div>
                                            <% } else { %>
                                                <div class="text-center py-5">
                                                    ...
                                                    <p class="text-muted mb-0">Try adjusting your search or status
                                                        filter.</p>
                                                </div>
                                                <% } %>
                                    </section>
